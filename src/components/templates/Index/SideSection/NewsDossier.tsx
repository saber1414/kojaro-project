    ...
    const news = [
        {
            ...
            title: "نظر مثبت ایکوموس به پرونده الموت؛ الموت واجد ارزش ثبت جهانی است",
            readCount: 16,
            date: "۱۱ روز قبل"
        },
        {
            ...
            title: "خسارت جنگ به گردشگری ایران اعلام شد؛ بیش از ۲۸ هزار میلیارد تومان در ۴۵ روز",
            readCount: 16,
            date: "۱۱ روز قبل"
        },
        {
            ...
            title: "تماشا کنید: روایت یک بحران؛ پشت پرده روزهای سخت گردشگری ایران",
            readCount: 16,
            date: "۱۱ روز قبل"
        },
    ];

    const NewsCard = ({ item, isMain }: { item: typeof news[0], isMain: boolean }) => {
    ...
    return (
        <>
            <div className="flex items-center">
                ...
                <h4 className="font-IRANYekan-Bold">پرونده خبری</h4>
            </div>
            <div className="mt-10">
                <div className="grid grid-cols-2 grid-rows-1 gap-4">
                    <NewsCard item={news[0]} isMain={true} />
                    {
                        news.slice(1).map((item) => <NewsCard key={item.id} item={item} isMain={false} />)
                    }
                </div>
            </div>
        </>
