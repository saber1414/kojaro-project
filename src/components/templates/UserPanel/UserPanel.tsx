...
import SummaryOfActivities from './SummaryOfActivities';
import HottestTopics from './HottestTopics';
import ProlificWriters from './ProlificWriters';
import Footer from '@/components/modules/Footer/Footer';

const UserPanelBox = () => {
    return (
        <>
            <div className="w-full h-95.5 ">
                ...
                <div className="w-full pt-8 pb-2 xl:px-8 lg:px-4 px-2 container">
                    <div className="flex flex-wrap gap-y-4 items-center lg:justify-between justify-center mt-10 lg:mt-0">
                        <div className="flex items-center gap-x-4 ml-4 lg:ml-0">
                            <Link href="#" className='w-32.5 rounded-sm h-7.5 flex items-center justify-center gap-x-2 text-gray-400 bg-white shadow shadow-gray-200'>
                    ...
                    <div className="mt-5">
                        <h2 className="text-center text-2xl font-IRANYekan-Bold">کجارو من</h2>
                        <p className="text-[14px] py-6 text-gray-500">در مورد خودتان در ۷۰ کلمه بنویسید این نوشته می‌تواند شامل توانایی‌ها، امیال، خواسته‌ها، علایق و فعالیت‌های شما در طول زندگی باشد و حتی می‌توانید در مورد خود اضافه گویی کنید و حتی خود را توصیف و معرفی کنید.</p>
                    </div>
                    {/* place of residence */}
                    <div className="mt-5">
                        <div className="mb-6 flex mt-4 flex-col gap-4 border-r border-gray-400 pr-4">
                            <span className='block text-xs leading-5 font-IRANYekan-Bold'>محل سکونت</span>
                            <Link href="#" className='font-IRANYekan-Bold flex items-center gap-x-2'>
                                <svg width="12" className='fill-blueMenu' height="12" viewBox="0 0 256 256"><path d="M228,128a12,12,0,0,1-12,12H140v76a12,12,0,0,1-24,0V140H40a12,12,0,0,1,0-24h76V40a12,12,0,0,1,24,0v76h76A12,12,0,0,1,228,128Z"></path></svg>
                                <span className='text-[14px] font-IRANYekan-Bold'>افزودن آدرس</span>
                            </Link>
                        </div>
                    </div>
                    {/* summary of your activities as a Kajaro member */}
                    <SummaryOfActivities />
                    {/* hottest topics */}
                    <HottestTopics />
