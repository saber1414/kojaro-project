...
const SummaryOfActivities = () => {
    return (
        <div className="mt-20">
            <div className="flex items-center">
                <span className="block bg-blueMenu w-1 h-6 ml-4"></span>
                <h4 className="font-IRANYekan-Bold md:text-[18px]">خلاصه فعالیت‌های شما به‌عنوان عضو کجارو</h4>
            </div>
            <div className="mt-5 flex items-center gap-x-4 flex-wrap gap-y-4">
