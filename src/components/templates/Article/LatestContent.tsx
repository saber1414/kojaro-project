    ...
    return (
        <>
            <div className="mt-10">
                ...
                <div className="mt-10">
                    <Link href="#" className='flex items-center gap-x-4 mb-2'>
                        <img src="/images/image14.jpg" className='w-18 h-12 rounded-md' alt="article image" />
                        <span className='text-[13px] font-IRANYekan-Bold'>دوربین جیبی که پرواز می‌کند؛ انقلابی در ثبت لحظات شگفت‌انگیز سفر</span>
                    </Link>
                    <Link href="#" className='flex items-center gap-x-4 mb-2'>
                        <img src="/images/image10.jpg" className='w-18 h-12 rounded-md' alt="article image" />
                    ...
                    <Link href="#" className='flex items-center gap-x-4 mb-2'>
                        <img src="/images/image07.jpg" className='w-18 h-12 rounded-md' alt="article image" />
                        <span className='text-[13px] font-IRANYekan-Bold'>چرا سفر به میراث جهانی یونسکو به ترند جدید گردشگران تبدیل شده است؟</span>
                    </Link>
                    <Link href="#" className='flex items-center gap-x-4 mb-2'>
                        <img src="/images/image24.jpg" className='w-18 h-12 rounded-md' alt="article image" />
                        <span className='text-[13px] font-IRANYekan-Bold'>کشف انبار مواد غذایی دوره سلجوقیان در شهر تاریخی آنی</span>
                    </Link>
                    <Link href="#" className='flex items-center gap-x-4 mb-2'>
                        <img src="/images/image02.jpg" className='w-18 h-12 rounded-md' alt="article image" />
