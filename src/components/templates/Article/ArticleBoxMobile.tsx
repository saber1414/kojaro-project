...
type ArticleBoxMobileProps = {
    scrollToCommentBox: () => void;
    progress: number;
}

const ArticleBoxMobile = ({ scrollToCommentBox, progress }: ArticleBoxMobileProps) => {
    return (
        <div className="flex">
            <div className='2xl:basis-[10%] xl:basis-[10%] hidden lg:block basis-0 mt-28'>
            ...
            <div className='2xl:basis-[70%] xl:basis-[65%]  basis-full'>
                ...
                <div className="mt-5">
                    <div className="border border-gray-200 p-2 rounded-sm">
                        <div className="flex md:items-center items-start md:flex-row flex-col justify-between">
                            <div className="flex items-start sm:items-center justify-between md:justify-normal flex-col sm:flex-row gap-x-8 w-full md:w-auto">
                                <div className="flex items-center justify-between sm:justify-normal gap-x-4 w-[inherit]">
                                ...
                                <div className="flex items-center gap-x-4 w-[inherit] justify-between sm:justify-normal mt-4 sm:mt-0">
...
export default ArticleBoxMobile;