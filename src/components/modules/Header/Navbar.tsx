...
const Navbar = () => {
    ...
    const { theme, setDarkMode, setLightMode, setSystemMode } = useDarkMode();
    ...
    const handleThemeSelect = (callback: () => void) => {
        callback();
    ...
    return (
        <>
            <div className='flex items-center justify-between relative'>
                ...
                />
                <div className='flex items-center gap-x-6 pl-8 relative'>
                    <button onClick={() => setShowThemeMenu(!showThemeMenu)} type="button" className='cursor-pointer'>
                        {
                            theme === "system" ? (
                                ...
                                <svg width="16" height="16" fill="var(--text)" viewBox="0 0 256 256" stroke="var(--text)"><path d="M116,36V20a12,12,0,0,1,24,0V36a12,12,0,0,1-24,0Zm80,92a68,68,0,1,1-68-68A68.07,68.07,0,0,1,196,128Zm-24,0a44,44,0,1,0-44,44A44.05,44.05,0,0,0,172,128ZM51.51,68.49a12,12,0,1,0,17-17l-12-12a12,12,0,0,0-17,17Zm0,119-12,12a12,12,0,0,0,17,17l12-12a12,12,0,1,0-17-17ZM196,72a12,12,0,0,0,8.49-3.51l12-12a12,12,0,0,0-17-17l-12,12A12,12,0,0,0,196,72Zm8.49,115.51a12,12,0,0,0-17,17l12,12a12,12,0,0,0,17-17ZM48,128a12,12,0,0,0-12-12H20a12,12,0,0,0,0,24H36A12,12,0,0,0,48,128Zm80,80a12,12,0,0,0-12,12v16a12,12,0,0,0,24,0V220A12,12,0,0,0,128,208Zm108-92H220a12,12,0,0,0,0,24h16a12,12,0,0,0,0-24Z"></path></svg>
                            ) : theme === "dark" && (
                                <svg width="16" height="16" fill="var(--grey-1)" viewBox="0 0 256 256"><path d="M236.37,139.4a12,12,0,0,0-12-3A84.07,84.07,0,0,1,119.6,31.59a12,12,0,0,0-15-15A108.86,108.86,0,0,0,49.69,55.07,108,108,0,0,0,136,228a107.09,107.09,0,0,0,64.93-21.69,108.86,108.86,0,0,0,38.44-54.94A12,12,0,0,0,236.37,139.4Zm-49.88,47.74A84,84,0,0,1,68.86,69.51,84.93,84.93,0,0,1,92.27,48.29Q92,52.13,92,56A108.12,108.12,0,0,0,200,164q3.87,0,7.71-.27A84.79,84.79,0,0,1,186.49,187.14Z"></path></svg>
                            )
                        }
                        <div className={`absolute z-30 w-55 h-39.5 rounded-lg bg-white left-20 top-8 shadow shadow-gray-400 py-4 px-4 ${showThemeMenu ? "flex" : "hidden"} flex-col gap-y-6`}>
                            <div className="cursor-pointer flex items-center justify-between">
                                <div onClick={() => handleThemeSelect(setLightMode)} className="flex items-center gap-x-2">
                                    <svg width="16" height="16" fill="var(--text)" viewBox="0 0 256 256" stroke="var(--text)"><path d="M116,36V20a12,12,0,0,1,24,0V36a12,12,0,0,1-24,0Zm80,92a68,68,0,1,1-68-68A68.07,68.07,0,0,1,196,128Zm-24,0a44,44,0,1,0-44,44A44.05,44.05,0,0,0,172,128ZM51.51,68.49a12,12,0,1,0,17-17l-12-12a12,12,0,0,0-17,17Zm0,119-12,12a12,12,0,0,0,17,17l12-12a12,12,0,1,0-17-17ZM196,72a12,12,0,0,0,8.49-3.51l12-12a12,12,0,0,0-17-17l-12,12A12,12,0,0,0,196,72Zm8.49,115.51a12,12,0,0,0-17,17l12,12a12,12,0,0,0,17-17ZM48,128a12,12,0,0,0-12-12H20a12,12,0,0,0,0,24H36A12,12,0,0,0,48,128Zm80,80a12,12,0,0,0-12,12v16a12,12,0,0,0,24,0V220A12,12,0,0,0,128,208Zm108-92H220a12,12,0,0,0,0,24h16a12,12,0,0,0,0-24Z"></path></svg>
                                    <span className='text-[14px]'>حالت روز</span>
                                </div>
                                {
                                    theme === "light" && (
                                        <svg width="16" height="16" className='fill-blueMenu' viewBox="0 0 256 256"><path d="M232.49,80.49l-128,128a12,12,0,0,1-17,0l-56-56a12,12,0,1,1,17-17L96,183,215.51,63.51a12,12,0,0,1,17,17Z"></path></svg>
                                    )
                                }
                            </div>
                            <div onClick={() => handleThemeSelect(setSystemMode)} className="cursor-pointer flex items-center justify-between">
                                <div className="flex items-center gap-x-2">
                                    <svg width="16" height="16" fill="var(--grey-1)" viewBox="0 0 256 256" stroke="var(--grey-1)"><path d="M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm12,24.87a83.53,83.53,0,0,1,24,7.25V203.88a83.53,83.53,0,0,1-24,7.25ZM44,128a84.12,84.12,0,0,1,72-83.13V211.13A84.12,84.12,0,0,1,44,128Zm144,58.71V69.29a83.81,83.81,0,0,1,0,117.42Z"></path></svg>
                                    <span className='text-[14px]'>حالت خودکار</span>
                                </div>
                                {
                                    theme === "system" && (
                                        <svg width="16" height="16" className='fill-blueMenu' viewBox="0 0 256 256"><path d="M232.49,80.49l-128,128a12,12,0,0,1-17,0l-56-56a12,12,0,1,1,17-17L96,183,215.51,63.51a12,12,0,0,1,17,17Z"></path></svg>
                            ...
                            <div className="cursor-pointer flex items-center justify-between">
                                <div onClick={() => handleThemeSelect(setDarkMode)} className="flex items-center gap-x-2">
                                    <svg width="16" height="16" fill="var(--grey-1)" viewBox="0 0 256 256"><path d="M236.37,139.4a12,12,0,0,0-12-3A84.07,84.07,0,0,1,119.6,31.59a12,12,0,0,0-15-15A108.86,108.86,0,0,0,49.69,55.07,108,108,0,0,0,136,228a107.09,107.09,0,0,0,64.93-21.69,108.86,108.86,0,0,0,38.44-54.94A12,12,0,0,0,236.37,139.4Zm-49.88,47.74A84,84,0,0,1,68.86,69.51,84.93,84.93,0,0,1,92.27,48.29Q92,52.13,92,56A108.12,108.12,0,0,0,200,164q3.87,0,7.71-.27A84.79,84.79,0,0,1,186.49,187.14Z"></path></svg>
                                    <span className='text-[14px]'>حالت شب</span>
                                </div>
                                {
                                    theme === "dark" && (
                                        <svg width="16" height="16" className='fill-blueMenu' viewBox="0 0 256 256"><path d="M232.49,80.49l-128,128a12,12,0,0,1-17,0l-56-56a12,12,0,1,1,17-17L96,183,215.51,63.51a12,12,0,0,1,17,17Z"></path></svg>
            ...
            {
                showThemeMenu && (
                    <div onClick={() => setShowThemeMenu(false)} className="fixed z-10 top-62 right-0 left-0 bottom-0"></div>
                )
            }
        </>
    )
