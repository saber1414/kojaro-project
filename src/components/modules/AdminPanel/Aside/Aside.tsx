...
const Aside = () => {
    ...
    return (
        <div ref={sidebarRef} className='aside bg-gray-12 lg:flex flex-col shadow shadow-l-gray-100 hidden'>
            <div>
            ...
            <ul ref={menuListRef} className={`scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 hover:scrollbar-thumb-gray-500 mt-5 flex-1 transition-all duration-300 ${hasOverflow ? 'overflow-y-auto overflow-x-hidden' : 'overflow-hidden'}`}>
                {
                    menus.map((item) => {
